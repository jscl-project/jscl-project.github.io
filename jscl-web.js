...
return (function(){try{return (function(){throw new internals.BlockNLX(v64,(function(){return (function(v77,v78){(function(){while (v77!==l6.value){v78=internals.car(v77);
...
l64.value=l64;
var l65=internals.intern('MAKE-STREAM');
var l66=internals.intern('*ERROR-OUTPUT*','COMMON-LISP');
var l67=internals.make_lisp_string('jqconsole-error');
var l68=internals.intern('*TRACE-OUTPUT*','COMMON-LISP');
var l69=internals.intern('HTML','KEYWORD');
l69.value=l69;
var l70=internals.intern('WELCOME-MESSAGE');
var l71=internals.make_lisp_string('load');
...
l63.value=l65.fvalue(internals.pv,l64.value,(function JSCL_USER_NIL(values,v93){internals.checkArgs(arguments.length-1,1);
var v94=this;
return l2.fvalue(values,v93);
}));
l66.value=l65.fvalue(internals.pv,l64.value,(function JSCL_USER_NIL(values,v95){internals.checkArgs(arguments.length-1,1);
var v96=this;
return l2.fvalue(values,v95,l3.value,l67);
}));
l68.value=internals.symbolValue(l63);
l70.fvalue(internals.pv,l69.value,l3.value);
return internals.js_to_lisp(internals.symbolValue(l5)['window']['addEventListener'](internals.lisp_to_js(l71),internals.lisp_to_js((function JSCL_USER_NIL(values){var v99=l6.value;
var I;
