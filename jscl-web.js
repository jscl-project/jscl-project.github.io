...
var l55=internals.intern('PRINC-TO-STRING','COMMON-LISP');
var l56=internals.make_lisp_string('jqconsole');
var l57=internals.make_lisp_string('Write');
...
internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l56)][internals.xstring(l57)](internals.lisp_to_js(l55.fvalue(internals.pv,v54)),internals.lisp_to_js(v55)));
...
l54;
var l58=internals.intern('TOPLEVEL');
var l59=internals.make_lisp_string('(');
var l60=internals.make_lisp_string(')');
var l61=internals.make_lisp_string('parents');
var l62=internals.make_lisp_string('jqconsole');
var l63=internals.make_lisp_string('RegisterMatching');
var l64=internals.make_lisp_string('~a> ');
var l65=internals.intern('*PACKAGE*','COMMON-LISP');
var l66=internals.intern('PACKAGE-NAME','COMMON-LISP');
var l67=internals.intern('FORMAT','COMMON-LISP');
var l68=internals.make_lisp_string('jqconsole-prompt');
...
var l73=internals.make_lisp_string('message');
var l74=internals.make_lisp_string('ERROR[!]: ~a~%');
var l75=internals.make_lisp_string('jqconsole-error');
var l76=internals.make_lisp_string('jqconsole');
var l77=internals.make_lisp_string('Write');
var l78=internals.intern('*HANDLER-BINDINGS*');
var l79=internals.intern('ERROR','COMMON-LISP');
var l80=internals.make_lisp_string('message');
var l81=internals.intern('%%ERROR');
var l82=internals.intern('READ-FROM-STRING','COMMON-LISP');
var l83=internals.intern('EVAL-INTERACTIVE');
var l84=internals.make_lisp_string('~S~%');
...
l58.fvalue=(function(){var FUNC=(function JSCL_USER_TOPLEVEL(values){internals.checkArgsAtMost(arguments.length-1,0);
var v59=this;
return (function(){internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l62)][internals.xstring(l63)](internals.lisp_to_js(l59),internals.lisp_to_js(l60),internals.lisp_to_js(l61)));
(function(v61){return internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l69)][internals.xstring(l70)](internals.lisp_to_js(v61),internals.lisp_to_js(l68)));
})(l67.fvalue(internals.pv,l6.value,l64,l66.fvalue(internals.pv,internals.symbolValue(l65))));
return (function(v88){return internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l88)][internals.xstring(l89)](internals.lisp_to_js(l3.value),internals.lisp_to_js(v88),internals.lisp_to_js(internals.symbolFunction(l32))));
...
var v72=[];
TBLOOP:while (true){try{switch(v71){case 1:(function(v73){return internals.bindSpecialBindings([l78],[v73],(function(){(function(){var v75=new internals.Cons(l79,(function JSCL_USER_NIL(values,v76){internals.checkArgs(arguments.length-1,1);
var v77=this;
v70=v76;
return (function(){throw new internals.TagNLX(v72,2);
})();
}));
var v78=new internals.Cons(v75,internals.symbolValue(l78));
return l78.value=v78;
})();
return (function(){try{return (function(){throw new internals.BlockNLX(v69,(function(){var x1=l33.fvalue(internals.pv,v62);
if (typeof x1!='number') throw 'Not a number!';
return x1>0?l3.value:l6.value;
})()!==l6.value?(function(){var v82=l82.fvalue(internals.pv,v62);
var v83=(function(){var FUNC=internals.symbolFunction(l37);
var ARGS=[internals.pv];
return (function(){var values=internals.mv;
var VS;
VS=l83.fvalue(values,v82);
...
internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l86)][internals.xstring(l87)](internals.lisp_to_js(l67.fvalue(internals.pv,l6.value,l84,v86)),internals.lisp_to_js(l85)));
l6.value;
...
})():l81.fvalue(internals.pv,(function(v80){return v80!==l6.value?v80:v79;
})(internals.js_to_lisp((function(){var TMP=v79[internals.xstring(l80)];
return TMP===undefined?l6.value:TMP;
})())));
}})();
}));
})(internals.symbolValue(l78));
...
internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l71)][internals.xstring(l72)](internals.lisp_to_js(v65)));
return (function(v68){return internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l76)][internals.xstring(l77)](internals.lisp_to_js(l67.fvalue(internals.pv,l6.value,l74,v68)),internals.lisp_to_js(l75)));
})((function(v66){return v66!==l6.value?v66:(function(v67){return v67!==l6.value?v67:v65;
})(l36.fvalue(internals.pv,v65));
})(internals.js_to_lisp((function(){var TMP=v65[internals.xstring(l73)];
return TMP===undefined?l6.value:TMP;
})())));
}})();
l24.fvalue(internals.pv);
return l58.fvalue(values);
})();
}));
})();
});
...
l91.value=l93.fvalue(internals.pv,l92.value,(function JSCL_USER_NIL(values,v91){internals.checkArgs(arguments.length-1,1);
var v92=this;
return l2.fvalue(values,v91);
}));
l95.fvalue(internals.pv,l94.value,l3.value);
return internals.js_to_lisp(internals.symbolValue(l4)[internals.xstring(l97)][internals.xstring(l98)](internals.lisp_to_js(l96),internals.lisp_to_js((function JSCL_USER_NIL(values){var v95=l6.value;
var I;
