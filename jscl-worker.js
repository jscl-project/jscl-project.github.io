...
var ARGS=[];
var _R;
_R=internals.withMV((function(){return 'output';
}));
...
var ARGS=[];
var _R;
_R=internals.withMV((function(){return v57;
}));
if (_R.mv!==null) ARGS=ARGS.concat(_R.mv);
 else ARGS.push(_R.result);
return internals.mvcall(FUNC,...ARGS);
...
var ARGS=[];
var _R;
_R=internals.withMV((function(){return v84;
}));
if (_R.mv!==null) ARGS=ARGS.concat(_R.mv);
 else ARGS.push(_R.result);
return internals.mvcall(FUNC,...ARGS);
...
var ARGS=[];
var _R;
_R=internals.withMV((function(){return l32;
}));
if (_R.mv!==null) ARGS=ARGS.concat(_R.mv);
 else ARGS.push(_R.result);
return internals.mvcall(FUNC,...ARGS);
...
var l79=internals.make_lisp_string('init');
var l80=internals.intern('STRING=');
...
return l80.fvalue(v132,l79)!==l9.value?((function(){return (function(){var FUNC=(function JSCL_USER_NIL(v136){switch(arguments.length){case 0:v136=l9.value;
;
default:break;
}var v135=l9.value;
var I;
...
var ARGS=[];
var _R;
_R=internals.withMV((function(){return v133;
}));
if (_R.mv!==null) ARGS=ARGS.concat(_R.mv);
 else ARGS.push(_R.result);
return internals.mvcall(FUNC,...ARGS);
})();
})(),internals.mvcall(l13.fvalue)):l9.value;
})();
});
}));
if (_R.mv!==null) ARGS=ARGS.concat(_R.mv);
